          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                ...
                {hasAccess('transporter', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                  <FormListItem
                    label="Transporter"
                    text={
                      <Link as={NextLink} href={`/transporters/view/${data?.transporter?.id}`}>
                        {data?.transporter?.service_info}
                      </Link>
                    }
                  />
                )}
