...
import { getTransporters } from 'apiSdk/transporters';
...
function CustomerCreatePage() {
  ...
  const formik = useFormik<CustomerInterface>({
    initialValues: {
      transporter_id: (router.query.transporter_id as string) ?? null,
    ...
    >
      <Box rounded="md">
        ...
        <FormWrapper onSubmit={formik.handleSubmit}>
          <AsyncSelect<TransporterInterface>
            formik={formik}
            name={'transporter_id'}
            label={'Select Transporter'}
            placeholder={'Select Transporter'}
            fetcher={getTransporters}
            labelField={'service_info'}
          />
