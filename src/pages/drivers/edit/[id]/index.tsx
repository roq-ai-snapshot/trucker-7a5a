    ...
    >
      <Box rounded="md">
        ...
        <FormWrapper onSubmit={formik.handleSubmit}>
          <TextInput
            error={formik.errors.trip_info}
            label={'Trip Info'}
            props={{
              name: 'trip_info',
              placeholder: 'Trip Info',
              value: formik.values?.trip_info,
              onChange: formik.handleChange,
            }}
          />

          <TextInput
            error={formik.errors.loading_slip}
            label={'Loading Slip'}
            props={{
              name: 'loading_slip',
              placeholder: 'Loading Slip',
              value: formik.values?.loading_slip,
              onChange: formik.handleChange,
            }}
          />

          <TextInput
            error={formik.errors.e_bill}
            label={'E Bill'}
            props={{
              name: 'e_bill',
              placeholder: 'E Bill',
              value: formik.values?.e_bill,
              onChange: formik.handleChange,
            }}
          />
